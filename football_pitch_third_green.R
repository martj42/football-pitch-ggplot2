...
ggplot(data=data.frame(x=1,y=1),aes(x,y))+
  ###grass:
  geom_rect(aes(xmin = -3, xmax = 71, ymin = -3, ymax = 38),
            fill = "darkolivegreen4", alpha = 0.7) +
  geom_rect(aes(xmin = 0, xmax = 68, ymin = 29.5, ymax = 35),
            fill = "darkolivegreen4", alpha = 0.7) +
  geom_rect(aes(xmin = 0, xmax = 68, ymin = 18.5, ymax = 24),
            fill = "darkolivegreen4", alpha = 0.7) +
  geom_rect(aes(xmin = 0, xmax = 68, ymin = 6.5, ymax = 12.5),
            fill = "darkolivegreen4", alpha = 0.7) +
  geom_rect(aes(xmin = 0, xmax = 68, ymin = -3, ymax = .5),
            fill = "darkolivegreen4", alpha = 0.7) +
  ###pitch:
  geom_path(data=data.frame(x=c(0,0,68,68),y=c(-3,35,35,-3)))+
  ##penalty spot:
  geom_point(aes(x = 34, y = 24), size = 1) +
  ###penalty arc:
