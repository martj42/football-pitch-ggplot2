...
ggplot(data=data.frame(x=1,y=1),aes(x,y))+
  ...
  geom_path(data=data.frame(x=c(-7280:(-1)/1000,1:7280/1000),y=-c(41.5-sqrt(9.15^2-c(-7280:(-1)/1000,1:7280/1000)^2))),aes(x=x,y=y))+
  ###corner arcs:
  geom_path(data=data.frame(x=c(0:1000/1000)-34,y=c(52.5-sqrt(1^2-c(0:1000/1000)^2))),aes(x=x,y=y))+
  geom_path(data=data.frame(x=c(0:1000/1000)-34,y=c(-52.5+sqrt(1^2-c(0:1000/1000)^2))),aes(x=x,y=y))+
  geom_path(data=data.frame(x=c(0:1000/1000)+33,y=c(52.5-sqrt(1^2-c(-1000:0/1000)^2))),aes(x=x,y=y))+
  geom_path(data=data.frame(x=c(0:1000/1000)+33,y=c(-52.5+sqrt(1^2-c(-1000:0/1000)^2))),aes(x=x,y=y))+
  ###corner lines:
  geom_path(data=data.frame(x=c(-34,-34.5),y=c(43.35,43.35))) +
  geom_path(data=data.frame(x=c(-34,-34.5),y=c(-43.35,-43.35))) +
  geom_path(data=data.frame(x=c(34,34.5),y=c(43.35,43.35))) +
  geom_path(data=data.frame(x=c(34,34.5),y=c(-43.35,-43.35))) +
  geom_path(data=data.frame(x=c(-25.85,-25.85),y=c(52.5,53))) +
  geom_path(data=data.frame(x=c(25.85,25.85),y=c(52.5,53))) +
  geom_path(data=data.frame(x=c(-25.85,-25.85),y=c(-52.5,-53))) +
  geom_path(data=data.frame(x=c(25.85,25.85),y=c(-52.5,-53))) +
  ###6-yard box:
